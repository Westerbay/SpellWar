...
Maintitle::Maintitle(AbstractGame * game, World * world, const LightInfo & lightInfo) : Scene() {
    _active = true;
    _world = world;
    _game = game;
    _state = MAIN;

    _lightDisplay = lightInfo.display;
    _activeNormalMapping = lightInfo.activeNormalMap;
    _activeParallaxMapping = lightInfo.activeParallaxMapping;
